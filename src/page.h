...
public:
                    ...
                    bool tx_prove = false)
    {
        ...
        {
            return string("Masari address not provided!");
        }
        ...
        if (!xmreg::parse_str_address(xmr_address_str,  address_info, nettype))
        {
            ...
            return string("Cant parse msr address: " + xmr_address_str);
        }
 ...
 */
                 ...
                 bool tx_prove = false)
    {
        ...
        {
            j_response["status"]  = "error";
            j_response["message"] = "Masari address not provided";
            return j_response;
        }
        ...
        {
            j_response["status"]  = "error";
            j_response["message"] = "Cant parse masari address: " + address_str;
            return j_response;
    ...
    json_networkinfo()
    {
        ...
        {
            j_response["status"]  = "error";
            j_response["message"] = "Cant get masari network info";
            return j_response;
        }
